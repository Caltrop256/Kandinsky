...
public class FoldNode extends BinaryInfixOperatorNode {
    static public final OperatorInfo info = new OperatorInfo("->>", 10);

    public FoldNode(CharInfo pos, Node left, Node right) {
        ...
        return this.left.eval(frame, scope, ContUtils.wrap(left -> {
            ...
            return this.right.eval(frame, scope, ContUtils.wrap(right -> {
                ...
                if(left.type == Typedef.array) {
                    ...
                    return arrayLoop(0, new IntegerValue(0), eleft, right, frame, scope, cont);
                }
                if(left.type == Typedef.string) {
                    return arrayLoop(0, new IntegerValue(0), (ArrayValue)left.coerceTo(Typedef.array, this), right, frame, scope, cont);
                }
