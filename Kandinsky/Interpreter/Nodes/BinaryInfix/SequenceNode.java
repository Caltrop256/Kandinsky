...
public class SequenceNode extends BinaryInfixOperatorNode {
    static public final OperatorInfo info = new OperatorInfo("°", 0);

    public SequenceNode(CharInfo pos, Node left, Node right) {
