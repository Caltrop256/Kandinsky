...
public class BitwiseNotNode extends BinaryInfixOperatorNode {
    static public final OperatorInfo info = new OperatorInfo("|", 8);

    public BitwiseNotNode(CharInfo pos, Node left, Node right) {
